addKiller("sohu", {
    ...
    */
    ...
    "process": function(data, s_callback) {
        ...
        function shift_en(i) {
            safari.extension.globalPage.contentWindow.console.log(this);
            var t = i.length,
                e = 0;
        ...
        function send_video(url) {
            ...
            safari.extension.globalPage.contentWindow.console.log(url);
